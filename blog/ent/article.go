...
func (*Article) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		switch columns[i] {
		case article.FieldIsDel, article.FieldIsAvailable:
			values[i] = &sql.NullBool{}
		case article.FieldID:
			values[i] = &sql.NullInt64{}
		case article.FieldCreatedBy, article.FieldModifiedBy, article.FieldTitle, article.FieldDesc, article.FieldContent:
...
func (a *Article) String() string {
	...
	builder.WriteString(a.ModifiedBy)
	builder.WriteString(", deleted_at=")
	builder.WriteString(a.DeletedAt.Format(time.ANSIC))
	builder.WriteString(", is_del=")
	builder.WriteString(fmt.Sprintf("%v", a.IsDel))
	...
	builder.WriteString(fmt.Sprintf("%v", a.IsAvailable))
	builder.WriteByte(')')
