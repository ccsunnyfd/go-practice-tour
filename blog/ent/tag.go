...
func (*Tag) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		switch columns[i] {
		case tag.FieldIsDel, tag.FieldIsAvailable:
			values[i] = &sql.NullBool{}
		case tag.FieldID:
			values[i] = &sql.NullInt64{}
		case tag.FieldCreatedBy, tag.FieldModifiedBy, tag.FieldName:
			values[i] = &sql.NullString{}
		case tag.FieldCreateTime, tag.FieldUpdateTime, tag.FieldDeletedAt:
...
func (t *Tag) String() string {
	...
	builder.WriteString(t.ModifiedBy)
